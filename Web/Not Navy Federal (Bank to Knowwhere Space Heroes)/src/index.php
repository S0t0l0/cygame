...
if ($num_receivers == 1 && $receiver == 'Snuffy') {
...
echo "<h2>Welcome Amn Snuffy</h2>";
echo "<p>Your current balance is: {$_SESSION['users']['Snuffy']}</p>";
 echo "<table>";
    ...
    echo "<input type='hidden' name='sender' value='Snuffy'>";
